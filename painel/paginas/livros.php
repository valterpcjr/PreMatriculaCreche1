...
?>
<div class="row t50-">
	<a onclick="inserir()" type="button" class="btn btn-primary"><span class="fa fa-plus"></span> Cadastrar Vaga</a>
...
<div class="row">
	...
	<div class="col-md-3 col-sm-6 b5">
		<select onchange="buscar()" class="form-control sel5" id="local_busca" style="width:100%">				<option value="">Selecione uma Unidade Escolar</option>				  
	...
	<div class="col-md-3 col-sm-6 b5">
		...
		<option value="Disponível">Vagas Disponíveis</option>	
		<option value="Emprestado">Vagas Solicitadas</option>	
		</select>	
	</div>
</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
							...
							<select class="form-control sel4" name="editora" id="editora" style="width:100%">					<option value="0">Selecione Responsável pelo Processo</option>			  
					...
					<div class="row">
						...
						<div class="col-md-2">							
							...
							<input type="number" class="form-control" id="quantidade" name="quantidade" value="1" placeholder="Quantidade" >							
						</div>


						<div class="col-md-2">							
							<label>Estoque</label>
							<input type="number" class="form-control" id="estoque" name="estoque" value="1" placeholder="Estoque" >							
						</div>
			...
			<div class="modal-body">
				<div class="row" style="margin-top: 0px">
					...
					<div class="col-md-6" style="margin-bottom: 5px">
						...
						<div class="col-md-6" style="margin-bottom: 5px">
						<span><b>Quantidade: </b></span><span id="quantidade_dados"></span>
					</div>
