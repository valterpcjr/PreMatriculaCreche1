...
<small>
	...
	<thead> 
	<tr> 
	<th class="esc">Vaga Solicitada</th>			
	<th class="esc">Data da Solicitação</th>
	<th class="esc"></th>
	<th class="esc"></th>
...
<div align="right" style="margin-top: 10px" class="verde">Total de Solicitações: {$linhas}</div>
HTML;

}else{
	echo '<small>Não possui nenhum registro de solicitação cadastrada!</small>';
}
?>
