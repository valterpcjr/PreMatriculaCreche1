...
<div class="row t50-">
	<a href="leitores" type="button" class="btn btn-primary"><span class="fa fa-plus"></span> Novo Empréstimo</a>
...
<div class="row">
	...
	<div class="" style="float:left; margin-right:10px"><span><small><i title="Data Inicial" class="fa fa-calendar-o"></i></small></span>
		...
		<select onchange="listarData()" class="form-control "  id="livro_busca" style="width:100%;"> 	
			...
			<option class="" value="">Filtrar por Livro</option>	
