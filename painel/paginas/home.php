...
//total emprestimos
$query = $pdo->query("SELECT * from emprestimos where devolvido != 'Sim'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
	...
	<div class="row-one widgettable">
		<div class="col-md-8 content-top-2 card" style="padding:20px">
			<div class="card-header">
				<h3>Unidades Escolares Mais Solicitadas</h3>
			</div>			
		...
		<div class="col-md-4 stat">
			<div class="content-top-1">
				<div class="col-md-6 top-content">
					<h5>Unidades Escolares Disponíveis</h5>
			...
			<!--<div class="content-top-1">
				<div class="col-md-6 top-content">
					...
					<label><?php echo $total_hoje ?></label>
				</div>
				<div class="col-md-6 top-content1">	   
			...
			var ctx = document.getElementById("canvas").getContext("2d");
					window.myBar = new Chart(ctx, {
						...
						options: {
							...
							title: {
								display: true,
								text: 'As 5 Unidades Escolares Mais Solicitadas'
							}
						}
					});
