		...
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				...
				<td style="width: 40%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>RELATÓRIO DE SOLICITAÇÕES</big> <?php echo mb_strtoupper($texto_filtro) ?>
						<?php echo mb_strtoupper($nome_livro) ?></b><br>
		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 10px; margin-bottom:10px; width: 100%; table-layout: fixed;">
			<thead>
				...
				<tr id="cabeca" style="margin-left: 0px; background-color:#CCC">
					<td style="width:28%">UNIDADE ESCOLAR</td>
					<td style="width:22%">NOME DO ALUNO</td>
					<td style="width:10%">VAGA SOLICITADA</td>
...
$total_emprestados = 0;
	...
	$query = $pdo->query("SELECT * from emprestimos where $status_livro $status >= '$inicio' and $status <= '$final' order by id desc");
...
<hr>
		<table>
			<thead>
				<tbody>
					<tr>
						<td style="font-size: 10px; width:332px; text-align: left;"><b>Solicitações: <?php echo $linhas ?></td>
						...
						<td style="font-size: 10px; width:130px; padding-right: 5px; text-align: right; color:red"><b>SOLICITADOS: <?php echo $total_emprestados ?></td>				
