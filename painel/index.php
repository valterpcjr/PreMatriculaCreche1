			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h3><a class="navbar-brand" href="index.php"><span class="fa fa-book"></span> CRECHE I<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h3>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							<li class="header"><h5>SMEL - Luziânia-GO</h5></li>
							...
							<li class="treeview <?php echo $menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $leitores ?>"><a href="leitores"><i class="fa fa-angle-right"></i> Solicitantes</a></li>
							...
							<li class="treeview <?php echo $menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $livros ?>"><a href="livros"><i class="fa fa-angle-right"></i> Vagas</a></li>

									<li class="<?php echo $categorias ?>"><a href="categorias"><i class="fa fa-angle-right"></i> Categorias Vagas</a></li>

									<!--<li class="<?php echo $cargos ?>"><a href="cargos"><i class="fa fa-angle-right"></i> Cargos</a></li>-->

									<li class="<?php echo $locais ?>"><a href="locais"><i class="fa fa-angle-right"></i> Unidades Escolares</a></li>

									<li class="<?php echo $editoras ?>"><a href="editoras"><i class="fa fa-angle-right"></i> SMEL</a></li>

									<!--<li class="<?php echo $grupos ?>"><a href="grupos"><i class="fa fa-angle-right"></i> Grupos</a></li>
							...
							<li class="treeview <?php echo $menu_emprestimos ?>">
								<a href="#">
									...
									<span>Gestão Solicitações</span>
									<i class="fa fa-angle-left pull-right"></i>
								</a>
								<ul class="treeview-menu">

									<li class="<?php echo $emprestimos_ativos ?>"><a href="emprestimos"><i class="fa fa-angle-right"></i>Solicitações Ativas</a></li>

									<!--<li class="<?php echo $lista_devolucoes ?>"><a href="devolucoes"><i class="fa fa-angle-right"></i> Lista de Devoluções</a></li>


									<li class="<?php echo $devolucoes_hoje ?>"><a href="devolucoes_hoje"><i class="fa fa-angle-right"></i> Devoluções de Hoje</a></li>


									<li class="<?php echo $devolucoes_atraso ?>"><a href="devolucoes_atraso"><i class="fa fa-angle-right"></i> Devoluções em Atraso</a></li>-->


									<li class="<?php echo $todos_emprestimos ?>"><a href="emprestimos_todos"><i class="fa fa-angle-right"></i>Todos as Solicitações</a></li>
									
								</ul>
							</li>


							<!--<li class="treeview <?php echo $solicitacoes ?>">
								<a href="solicitacoes">
									<i class="fa fa-check-square"></i> <span>Solicitações</span>
								</a>
							</li>-->
			...
			<div class="modal-body">
				...
				<div class="row">
						...
						<div class="col-md-4">							
							...
							<div class="col-md-3">							
								<label>Máximo Empréstimos</label>
								<input type="number" class="form-control" id="emprestimos_leitor" name="emprestimos_leitor" placeholder="Quantidade Livros Leitor" value="<?php echo @$emprestimos_leitor ?>">							
						</div>
