...
for($i=0; $i<$linhas; $i++){
	...
	$emprestados = $quantidade - $estoque;

	$livros_emprestados += $emprestados;
	$livros_disponiveis += $estoque;
...
<td style="width:22%"><?php echo $quantidade ?> / <?php echo $titulo ?></td>
...
<td style="width:10%"><?php echo $nome_local ?></td>
<td style="width:7%"><?php echo $estoque ?> / <?php echo $quantidade ?></td>
<td style="width:6%"><img src="<?php echo $url_sistema ?>img/<?php echo $classe_ativo ?>" width="12px"></td>
    </tr>
...
<hr>
		<table>
			<thead>
				<tbody>
					<tr>
						<td style="font-size: 10px; width:332px; text-align: left;"<b>Total de Livros: <?php echo $total_livros ?></td>
